        ...
        protected List<StructureReportEntity> compute() {
            ...
            if ((endNumber - begin) < threshold) {
                ...
                for (int i = begin; i < endNumber; i++) {
                    ...
                    //计算点击率
                    if(objectList.get(i).getMobileImpression() + ((objectList.get(i).getMobileImpression() == null) ? 0 : objectList.get(i).getMobileImpression()) == 0){
                        ...
                        objectList.get(i).setPcCtr(newNumber);
                    }
                    //计算平均点击价格
                    if(objectList.get(i).getPcClick() + ((objectList.get(i).getMobileClick() == null) ? 0 : objectList.get(i).getMobileClick()) == 0){
                    ...
                    objectList.get(i).setPcImpression(objectList.get(i).getMobileImpression() + ((objectList.get(i).getMobileImpression() == null) ? 0 : objectList.get(i).getMobileImpression()));
