...
/**
 * Created by XiaoWei on 2014/8/1.
 */
public class ImportKeywordFork  extends RecursiveTask<Map<Long,KeywordRealTimeDataVOEntity>> {
    ...
    public ImportKeywordFork(List<KeywordRealTimeDataVOEntity> analyzeEntities, int begin, int endNumber) {
