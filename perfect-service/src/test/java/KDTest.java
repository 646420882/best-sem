...
public class KDTest {
    public static void main(String[] args) {
        String k0 = "婚博会0";
        String k0MD5 = KeywordDeduplication.MD5.getMD5(k0);
        String k1 = "婚博会";
        String k2 = "婚博会 优";
        int size = 100_00_000;
        ...
        boolean d2 = list.stream().anyMatch(k -> k0MD5.equals(KeywordDeduplication.MD5.getMD5(k)));
        long l4 = System.currentTimeMillis();
        System.out.println(d2 + ", l4 - l3 = " + (l4 - l3));

        String k1MD5 = KeywordDeduplication.MD5.getMD5(k1);
        String k2MD5 = KeywordDeduplication.MD5.getMD5(k2);
