...
public class CampaignType
{
  ...
  public boolean setInternalType(Integer aInternalType)
  {
    boolean wasSet = false;
    internalType = aInternalType;
    wasSet = true;
    return wasSet;
  }

  public boolean setCampaignType(Integer aCampaignType)
  {
    boolean wasSet = false;
    campaignType = aCampaignType;
    wasSet = true;
    return wasSet;
  }
  ...
  public boolean setDynCreativeExclusion(String aDynCreativeExclusion)
  {
    boolean wasSet = false;
    dynCreativeExclusion = aDynCreativeExclusion;
    wasSet = true;
    return wasSet;
  }
  ...
  public String toString()
  {
    ...
    return super.toString() + "["+
            ...
            "dynCreativeExclusion" + ":" + getDynCreativeExclusion()+ "," +
