...
<%--alert提示类--%>
<div class="box7" style=" width: 230px;display:none;z-index: 1001" id="baiduAccountAlertPrompt">
    <h2>
        <span class="fl" id="baiduAccountAlertPrompt_title"></span>
        <a href="#" onclick="baiduAccountAlertPrompt.hide()" style="color: #cccccc;float: right;font-size: 20px;font-weight: normal;opacity: inherit;text-shadow: none;">×</a></h2>
    <div class="mainlist">
        <div class="w_list03">
            <ul class="zs_set">
