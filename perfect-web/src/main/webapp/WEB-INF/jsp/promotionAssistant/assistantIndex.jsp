                                        ...
                                        <div class="containers">
                                            <div class="zs_function">
                                                <ul class="fl">
                                                    ...
                                                    <li><a id="timing"   href="#"><span class="zs_top"><img src="../public/img/zs_function20.png"></span><b>定时&nbsp;</b><input type="image"   src="../public/img/zs_input.png"></a>
                                                        <ul  id="timing1" class="hides">
                                                            <li id="timediglogUp"><a href="#"><span class="zs_top1"><img src="../public/img/zs_function21.png"></span><b>定时上传</b></a></li>
                                                            <li id="timediglogDown"><a href="#"><span class="zs_top1"><img src="../public/img/zs_function22.png"></span><b>定时暂停</b></a></li>
                                                        </ul>
                                                    </li>   
                                                </ul>
                                            </div>
