...
<div class="zhushou_menu">
    <ul class="zs_nav">
        ...
        <li class="current"><a href="javascript:void(0)" onclick="alert('该功能还在开发中!');"><span><img
                src="../public/img/Advanced_search.png"></span><span>高级搜索</span></a></li>
    ...
    <div class="zs_function">
        <ul class="fl">
            ...
            <li><a href="#" id="reduction"><span class="z_function_hover"><img
                    src="../public/img/zs_function9.png"></span><b>还原</b></a><%--z_function_hover--%> </li>
            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="t_list02 fl over"><input type="text" onblur="whenBlurEditKeyword(3,this.value)"
                                                         onkeydown="missBlur(event,this)" class="zs_input1 pcurl_1"
                                                         maxlength="1024"><span
                ...
                <li>
                    ...
                    <div class="t_list02 fl over"><input type="text" onblur="whenBlurEditKeyword(4,this.value)"
                                                         onkeydown="missBlur(event,this)" class="zs_input1 mourl_1"
                                                         maxlength="1024"><span
            ...
            <ul>
                <li>
                    ...
                    <div class="t_list06 fl over"><input type="text" onblur="whenBlurEditCampaign(1,this.value);"
                                                         ...
                                                         class="zs_input3 campaignName_5" maxlength="30"></div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="t_list06 fl over"><input type="text" onblur="whenBlurEditCampaign(3,this.value);"
                                                         onkeydown="missBlur(event,this);"
                                                         class="zs_input3 priceRatio_5" maxlength="3"
