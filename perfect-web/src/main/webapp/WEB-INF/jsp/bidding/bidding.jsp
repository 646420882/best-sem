                            ...
                            <div class="zhushou_concent over">
                                <div class="wrap_list01 over wd ">
                                    <ul>
                                        ...
                                        <span>
                                            <form>
                                                <div class="input_box"><input type="radio" name="in" checked="checked"
                                                                              value="0">&nbsp;全部&nbsp;</div>
                                                <div class="input_box"><input type="radio" name="in" value="-1">&nbsp;未参与
                                                    &nbsp;</div>
                                                <div class="input_box"><input type="radio" name="in" value="1"> &nbsp;已参加&nbsp;
                                                </div>
                                            </form>
                                        </span>
                                        <span>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="w_list02 fl over" id="matchType">
                                                    <div class="input_box"><span><input type="checkbox" name="matchType"
                                                                                        checked="checked" value="1">&nbsp;精准</span>
                                                    </div>
                                                    <div class="input_box"><span><input type="checkbox" name="matchType"
                                                                                        value="2">&nbsp;短语-核心</span>
                                                    </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="w_list02 fl over" id="keywordQuality">
                                                    <ul>
                                                        <li>
                                                            <div class="input_box"><span><input type="checkbox"
                                                                                                name="keywordQuality"
                                                                                                value="1"
                                                                                                checked="checked">&nbsp;一分词</span>
                                                            </div>
                                                            <div class="input_box"><span><input type="checkbox"
                                                                                                name="keywordQuality"
                                                                                                value="2"
                                                                                                checked="checked">&nbsp;二分词</span>
                                                            </div>
                                                            <div class="input_box"><span><input type="checkbox"
                                                                                                name="keywordQuality"
                                                                                                value="3"
                                                                                                checked="checked">&nbsp;三分词</span>
                                                            </div>
                                                            <div class="input_box"><span><input type="checkbox"
                                                                                                name="keywordQuality"
                                                                                                value="4"
                                                                                                checked="checked">&nbsp;四分词</span>
                                                            </div>
                                                            <div class="input_box"><span><input type="checkbox"
                                                                                                name="keywordQuality"
                                                                                                value="5"
                                                                                                checked="checked">&nbsp;五分词</span>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="input_box"><span><input type="checkbox"
                                                                                                name="keywordQuality"
                                                                                                value="6"
                                                                                                checked="checked">&nbsp;六分词</span>
                                                            </div>
                                                            <div class="input_box"><span><input type="checkbox"
                                                                                                name="keywordQuality"
                                                                                                value="7"
                                                                                                checked="checked">&nbsp;七分词</span>
                                                            </div>
                                                            <div class="input_box"><span><input type="checkbox"
                                                                                                name="keywordQuality"
                                                                                                value="8"
                                                                                                checked="checked">&nbsp;八分词</span>
                                                            </div>
                                                            <div class="input_box"><span><input type="checkbox"
                                                                                                name="keywordQuality"
                                                                                                value="9"
                                                                                                checked="checked">&nbsp;九分词</span>
                                                            </div>
                                                            <div class="input_box"><span><input type="checkbox"
                                                                                                name="keywordQuality"
                                                                                                value="10"
                                                                                                checked="checked">&nbsp;十分词</span>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </div>
...
//            $.fn.zTree.init($("#zTree2"), setting, zNodes);
        ...
        grid = $("#table1").jqGrid({
            ...
            colModel: [
                ...
                {label: ' 当前排名', name: 'currentRank', sortable: false, width: 90, align: 'center'},
                {label: ' 消费', name: 'cost', sortable: false, width: 80, align: 'center'},
                {label: ' 展现量', name: 'impression', sortable: false, width: 80, align: 'center'},
                {label: ' 点击量', name: 'click', sortable: false, width: 80, align: 'center'},
                {label: ' 点击率', name: 'ctr', sortable: false, width: 80, align: 'center', hidden: true},
                ...
                {label: ' 移动端质量度', name: 'mQuality', sortable: false, align: 'center', hidden: true},
                {label: ' 状态', name: 'statusStr', sortable: false, width: 80, align: 'center'},
                ...
                {label: ' 竞价状态', name: 'biddingStatus', sortable: false, width: 80, align: 'center'},
...
//            alert(JSON.stringify($("#table1").jqGrid("getRowData")));
        ...
        grid2 = $("#table2").jqGrid({
            ...
            colModel: [
                ...
                {label: ' 点击量', name: 'click', sortable: false, align: 'center'},
                {label: ' 点击率', name: 'ctr', sortable: false, align: 'center', hidden: true},
                ...
                {label: ' Pc URL', name: 'pcDestinationUrl', sortable: false, hidden: true, align: 'center', formatter: 'link'},
                {label: ' Mobile URL', name: 'mobileDestinationUrl', sortable: false, hidden: true, align: 'center', formatter: 'link'},
