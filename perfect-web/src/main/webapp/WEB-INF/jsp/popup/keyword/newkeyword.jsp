                        ...
                        <div class="containers2 over">
                            <div class="newkeyword_left fl  over">
                                ...
                                <div class="newkeyword_top2">
                                    ...
                                    <div class="newkeyword_top3">
                                        <a href="#">空</a><a href="#">有效</a><a href="#">已暂停</a><a href="#"
                                                                                                 class="current">全部</a>
                                    </div>
                                </div>
                            </div>
                            <div class="newkeyword_right fr over">
                                ...
                                <div class="newkeyword_right_mid">
                                    ...
                                    <p><label for="Replace"><input type="checkbox" id="Replace">&nbsp;用这些关键词替换目标推广单元的所有对应内容</label>
                                    </p>

                                    <p><label for="Replaces"><input type="checkbox" id="Replaces">&nbsp;用输入的关键词搜索更多相关关键词，把握题词质量</label>
                                    </p>
                        ...
                        <div class="containers2 over hides">
                            <div class="newkeyword_right fr over" style="width:100%;">
                                ...
                                <div class="newkeyword_right_mid">
                                    ...
                                    <p><label for="Replacese"><input type="checkbox" id="Replacese">&nbsp;用这些关键词替换目标推广单元的所有对应内容</label>
                                    </p>
                                ...
                                <div class="newkeyword_end2 ">
                                    ...
                                    <div class="list4" style="height:300px;">
                                        <table width="100%" cellspacing="0" border="0" width="500px">
                                            <thead>
                                            <tr class="list02_top">
                                                <td>&nbsp; <input type="checkbox" id="checkAll2" checked="checkde">关键词
                                                </td>
                                                <td>&nbsp;展现理由</td>
                                                <td>&nbsp;日均搜索量</td>
                                                <td>&nbsp;竞争激烈程度
                                            ...
                                            <tbody>
                                            <tr class="list2_box2">
                                                <td> &nbsp;<input type="checkbox" checked="checked" name="subbox2">北京婚博会
                                                </td>
                                                <td>&nbsp;111</td>
                                                <td>&nbsp;1111</td>
                                                <td>&nbsp;1111</td>
