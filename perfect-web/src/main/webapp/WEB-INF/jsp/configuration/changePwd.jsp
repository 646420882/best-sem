            ...
            <div class="login_input2">
                <form id="defaultForm" method="post" class="form-horizontal" action="/account/updatePwd">
                    <ul>
                        ...
                        <li style="margin:0px 0 0 30px;">
                            <button type="submit" id="submitPwd" class="btn btn-primary" style="margin-right:10px; ">确认</button>
        ...
        $("#currentPWD").blur(function(){
            $.ajax({
                ...
                success: function (data) {
                    if (data.sturts == 1) {
                        $("#messageSpan").html("<small class='help-block'>密码验证成功</small>");
                        $("#submitPwd").attr("type","submit");
                        setTimeout('$("#messageSpan").html("")',3000);
                        pwdPub = 1;
                    }else{
                        $("#messageSpan").html("<small class='help-block'>当前密码不匹配</small>");
