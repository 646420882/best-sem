...
<body>
            		    ...
            		    <div class="control-group">
            		      <div class="controls">
            		       <div class="input-prepend input-group">
            		         <input type="text" readonly="readonly" style="width: 200px" name="reservation" id="reservation" class="form-control" value="2015-11-21 - 2015-12-21" /> 
	...
	<div class="black operation-tip">
			<div class="tip-box">
				...
				<div class="check-all">
					<a href="javascript:;" class="check-now" id="all-check">全部</a>|<a href="javascript:;"id="user-defined" >自定义</a>
				</div>
