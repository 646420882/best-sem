...
lxb.add("config", function (a) {
    var c = lxb.use("base");
    var e = {BDCBID: '31ddd99a-9449-492b-9162-0cdc9fde919f', LXBVT: 1, TEMPSITEID: '177867', TEMPPORT: 'lxbjs.baidu.com/', TEMPFILEROOT: 'float'};
    var b = {BDCBID: "bdcbid", LXBVT: 1, TEMPSITEID: "siteid", TEMPPORT: "localhost:7710", TEMPFILEROOT: "/float"};
    c.extend(b, e);
...
lxb.add("business.callback", function (q) {
    ...
    function r() {
        ...
        var t = k.input = i.create("input", {type: "text", name: "phone", className: f.CB_INPUT, maxlength: 12, value: l});
        var y = k.cbCon = i.create("ins", {className: "lxb-callback-container"});
        k.cbCon.appendChild(t);
        var v = k.btn = i.create("ins", {className: f.CB_INPUT_BTN});
        ...
        if (b.displayGroup()) {
            ...
            var x = k.groupContainer = i.create("ins", {className: "lxb-group-container"});
            k.cbCon.appendChild(x);
            for (var u = 0; u < g.groupDetail.length; u++) {
                var z = i.create("ins", {groupid: g.groupDetail[u].groupid, title: "\u514D\u8D39\u56DE\u7535", className: "lxb-group-btn"});
        ...
        var w = k.tip = i.create("ins", {className: f.CB_INPUT_TIP});
        w.style.display = "none";
        w.innerHTML = d.CB_INPUT_TIP_1;
        if (i.ie && i.ie <= 6) {
            w.appendChild(i.create("iframe", {className: f.MAIN + "-mask", frameBorder: 0}))
        }
    ...
    function p() {
        var u = k.infoLayer;
        u = k.infoLayer = i.create("ins", {className: f.CB_INFO_TIP});
        u.innerHTML = d.CB_INFO_TIP_MAIN;
        var t = u.getElementsByTagName("ins");
        k.tipCon = t[0];
        k.tipOpt = {arrow: t[1], close: t[2], con: g.main, tipEle: u};
    ...
    function a() {
        ...
        if (!t) {
            t = k.loadingLayer = i.create("ins", {className: f.CB_LOADING_TIP});
    ...
    function j(w, v) {
        ...
        var y = {vtel: w, siteid: g.siteid, bdcbid: t, code: g.code};
        if (v) {
            y.g = v
        }
