 ...
 */
public class DataPullTaskConfig extends BaseTaskConfig{

    public DataPullTaskConfig(String baseTaskName, String ownSig, String dealBean, String cronExp, String[] taskDef) {
