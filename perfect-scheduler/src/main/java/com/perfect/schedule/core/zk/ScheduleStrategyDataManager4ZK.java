...
import com.perfect.schedule.core.strategy.ScheduleStrategyRuntime;
...
public class ScheduleStrategyDataManager4ZK {
    ...
    public ScheduleStrategyRuntime loadScheduleStrategyRunntime(String strategyName, String uuid) throws Exception {
     ...
     * @throws Exception
     */
    public List<ScheduleStrategyRuntime> loadAllScheduleStrategyRunntime() throws Exception {
    ...
    public List<ScheduleStrategyRuntime> loadAllScheduleStrategyRunntimeByUUID(String managerFactoryUUID) throws Exception {
        List<ScheduleStrategyRuntime> result = new ArrayList<ScheduleStrategyRuntime>();
        String zkPath = this.PATH_Strategy;
    ...
    public List<ScheduleStrategyRuntime> loadAllScheduleStrategyRunntimeByTaskType(String strategyName) throws Exception {
        List<ScheduleStrategyRuntime> result = new ArrayList<ScheduleStrategyRuntime>();
        String zkPath = this.PATH_Strategy;
