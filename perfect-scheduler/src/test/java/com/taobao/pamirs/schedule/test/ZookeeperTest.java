...
import com.perfect.schedule.core.zk.ScheduleWatcher;
import com.perfect.schedule.core.zk.ZKTools;
...
public class ZookeeperTest {
    private String HOST = "192.168.1.103:2181";

	@Test
	public void testCloseStatus() throws Exception {
		ZooKeeper zk = new ZooKeeper(HOST, 3000,
